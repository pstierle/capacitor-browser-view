...
class WebviewOverlay: UIViewController, WKUIDelegate, WKNavigationDelegate {
    ...
    var plugin: CapacitorBrowserViewPlugin!
    ...
    init(_ plugin: CapacitorBrowserViewPlugin, configuration: WKWebViewConfiguration) {
    ...
    override func loadView() {
        ...
        let image = UIImage(named: "icon", in: Bundle(for: NSClassFromString("CapacitorBrowserViewPlugin")!), compatibleWith: nil)
...
@objc(CapacitorBrowserViewPlugin)
public class CapacitorBrowserViewPlugin: CAPPlugin {
    var width: CGFloat!
    var height: CGFloat!
    var x: CGFloat!
    var y: CGFloat!
